  ...
  return (
    <Container id='about' className='p-5'>
      <Row style={{ minHeight: "400px" }}>
        <Col sm={4} className='border border-dark d-flex align-items-center justify-content-center flex-column  '>
          <div sm={12} className='bg-dark' style={{ height: "200px", width: "200px", margin: "0 auto", borderRadius: "20px" }}>
        ...
        <Col sm={8} className='about-me-content border  d-flex align-items-center justify-content-center flex-column'>
          <Row className='properties w-100' style={{ minHeight: "150px" }}>
            <Col className='border border-dark m-1'></Col>
            <Col className='border border-dark m-1'></Col>
            <Col className='border border-dark m-1'></Col>
          </Row>
